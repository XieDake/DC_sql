use training;
#这个表中主要是在上一次merge的282维特征的基础上按特征重要性进行删减特征！！
#这一次共有:282-25=257维特征！
#终于拿头敲开你的门！fighting！
#按照特征重要性去掉25维重要程度<=10^-5的特征!
#features都是补齐过的！
drop table if exists training_merge_2017117;
create table training_merge_2017117
(
select
t6.user_id,
...
#贷后52！
#去掉5，6，8，9，11，23，25，33，34，36，37，39，48！还剩39维！
#21+18+13
...
#划分正负样本集！
#划分正负样本集！
drop table if exists training_positive_2017117;
#0
create table training_positive_2017117
(
select * from training_merge_2017117
where lable=0
);
#1
drop table if exists training_negtive_2017117;
create table training_negtive_2017117
(
select * from training_merge_2017117
where lable=1
);