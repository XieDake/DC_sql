use training;
#这个表中主要是用户属性和变种特征！还有用户的信用卡特征！
#这一次共有：173—24+12=161维特征！
#终于拿头敲开你的门！fighting！
#1：基于前面173维特征表(#features_0:15维！features_credit_0:(52*3+2=)158维！)中
#按照特征重要性去掉24维重要程度<=10^-5的特征！training_merge_贷前贷后交叉！
#2：加入基于上述分析发现的时间特征的创造性添加一些特征（比较强力）12维！features_credit_1;
#features都是补齐过的！
drop table if exists training_merge_2017113;
create table training_merge_2017113
(
select
t4.user_id,
#features_0:15
...
#3）各项对应的变化率：（差）/均值！52维！
#去掉：5，6，7，8，9，24，28，32，33，34，35，36，37，40，47，50
#21: features_1
...
############################
#以下是比较强力的12维特征！
t3.credit_use_times_before,
t3.min_credit_time_use_before,
t3.max_credit_time_use_before,
t3.bias_credit_time_use_before,
t3.creditCard_active_before,
t3.credit_use_times_after,
t3.min_credit_time_use_after,
t3.max_credit_time_use_after,
t3.bias_credit_time_use_after,
...
#划分正负样本集！
#划分正负样本集！
drop table if exists training_positive_2017113;
#0
create table training_positive_2017113
(
select * from training_merge_2017113
where lable=0
);
#1
drop table if exists training_negtive_2017113;
create table training_negtive_2017113
(
select * from training_merge_2017113
where lable=1
);