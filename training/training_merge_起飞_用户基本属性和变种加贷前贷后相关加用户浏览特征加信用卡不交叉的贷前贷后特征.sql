...
#划分正负样本集！
#划分正负样本集！
drop table if exists training_positive_2017116;
#0
create table training_positive_2017116
(
select * from training_merge_2017116
where lable=0
);
#1
drop table if exists training_negtive_2017116;
create table training_negtive_2017116
(
select * from training_merge_2017116
where lable=1
);