use training;
#merge: features_0,features_1,overdue
#create table!
...
;
#划分正负样本集！
drop table if exists training_positive_3;
#0
create table training_positive_3
(
select * from training_merge_3
where lable=0
);
#1
drop table if exists training_negtive_3;
create table training_negtive_3
(
select * from training_merge_3
where lable=1
);