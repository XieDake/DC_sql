...
#划分正负样本集！
#划分正负样本集！
drop table if exists training_positive_2017112;
#0
create table training_positive_2017112
(
select * from training_merge_2017112
where lable=0
);
#1
drop table if exists training_negtive_2017112;
create table training_negtive_2017112
(
select * from training_merge_2017112
where lable=1
);