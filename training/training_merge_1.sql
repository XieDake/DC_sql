...
;
#划分正负样本集！
drop table if exists training_positive_2;
#0
create table training_positive_2
(
select * from training_merge_1
where lable=0
);
#1
drop table if exists training_negtive_2;
create table training_negtive_2
(
select * from training_merge_1
where lable=1
);
